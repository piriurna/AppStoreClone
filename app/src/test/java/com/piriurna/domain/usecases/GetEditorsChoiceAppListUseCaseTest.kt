...
class GetEditorsChoiceAppListUseCaseTest : BaseUseCaseTest() {

    private lateinit var getEditorsChoiceAppListUseCase: GetEditorsChoiceAppListUseCase
    private lateinit var aptoideRepository: AptoideRepository

    @Before
    fun setUp() {
        aptoideRepository = mock()
        getEditorsChoiceAppListUseCase = GetEditorsChoiceAppListUseCase(aptoideRepository = aptoideRepository)
    }
    ...
    fun `ask for data and receive data`() = runTest {
        ...
        getEditorsChoiceAppListUseCase()
            .test()
            .assertNoErrors()
            .assertValue {
